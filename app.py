...
TOKEN = "6534400297:AAGV3uW-eolyA7yIm9PAHKVKy9WoFL9tygС"
...
def main():
    st.title("Для продолжения введи ту самую дату...")
    st.write("Количество попыток и время пользования ограничено, но достаточно. Следуй инструкциям в сообщениях.")
